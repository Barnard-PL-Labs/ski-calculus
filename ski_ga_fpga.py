"""Self-contained SKI GA throughput engine for FPGA submission (K=4 cores).

Generated from ga_design.py (Evaluator removed so GAEngine is the unique
Wishbone-port top-level the build server auto-detects). Change K by
editing the GAEngine default; ~60 cores fit on the ECP5-85 (LUT-bound).
"""
